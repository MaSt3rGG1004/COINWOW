...
COINWOW Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring COINWOW Core

**When configuring COINWOW Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring COINWOW Core:
...
variables will be set when generating the COINWOW Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
