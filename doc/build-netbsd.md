...
This guide describes how to build coinwowd, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run coinwowd or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/coinwow/coinwow/blob/master/doc/descriptors.md).
...
There are many ways to configure COINWOW Core. Here is an example that
