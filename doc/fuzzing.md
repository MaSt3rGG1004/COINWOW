# Fuzzing COINWOW Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing COINWOW Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/coinwow/coinwow
$ cd coinwow/
$ cmake --preset=libfuzzer
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/coinwow/coinwow/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
...
## Overview of COINWOW Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/coinwow_report.pdf) includes an external overview of the status of COINWOW Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.

## Fuzzing harnesses and output

[`process_message`](https://github.com/coinwow/coinwow/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/coinwow/coinwow/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/coinwow/coinwow/tree/master/src/test/fuzz).
...
It is possible to specify `coinwowd` arguments to the `fuzz` executable.
...
an instrumentalized libc++, then using it to build [COINWOW Core dependencies
from source](../depends/README.md) and finally the COINWOW Core fuzz binary
...
# Fuzzing COINWOW Core using afl++

## Quickstart guide

To quickly get started fuzzing COINWOW Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing COINWOW Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing COINWOW Core using [Honggfuzz](https://github.com/google/honggfuzz):
