...
```sh
cmake --build build --target coinwowd coinwow-cli
cmake --build build --target coinwow-qt
cmake --build build --target bench_coinwow
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:coinwow/coinwow.git
```
...
> e.g. github.com/coinwow/coinwow.git or for the GUI github.com/coinwow-core/gui
