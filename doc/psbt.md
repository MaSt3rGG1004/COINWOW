# PSBT Howto for COINWOW Core

Since COINWOW Core 0.17, an RPC interface exists for Partially Signed COINWOW
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/coinwow/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for COINWOW transactions that are not fully signed
...
#### Multisig with multiple COINWOW Core instances
