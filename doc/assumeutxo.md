...
Assumeutxo is a feature that allows fast bootstrapping of a validating coinwowd
instance.
...
```
$ coinwow-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ coinwow-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
