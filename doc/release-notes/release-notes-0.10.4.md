COINWOW Core version 0.10.4 is now available from:

  <https://coinwow.org/bin/coinwow-core-0.10.4/>
...
- #6953 `43c2789` Split coinwow-tx into its own package
- #6953 `dfe0d4d` Include coinwow-tx binary on Debian/Ubuntu
