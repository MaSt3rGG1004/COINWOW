COINWOW Core version *0.15.2* is now available from:

  <https://coinwowcore.org/bin/coinwow-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in coinwow-tx (TheBlueMatt)
