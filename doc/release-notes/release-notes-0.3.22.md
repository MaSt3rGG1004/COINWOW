Download URL: https://sourceforge.net/projects/coinwow/files/COINWOW/coinwow-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CW fee schedule (users still pay 0.01 CW per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #coinwow00 - #coinwow99
