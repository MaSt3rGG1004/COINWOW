COINWOW Core version 0.13.2 is now available from:

  <https://coinwow.org/bin/coinwow-core-0.13.2/>
...
- #8908 `4a974b2` Update coinwow-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow coinwow-tx to create v2 transactions (btcdrak)
