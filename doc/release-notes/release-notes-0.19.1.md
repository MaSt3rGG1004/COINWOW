...
COINWOW Core version 0.19.1 is now available from:

  <https://coinwowcore.org/bin/coinwow-core-0.19.1/>
...
From COINWOW Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as COINWOW Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, COINWOW Core does not yet change appearance when
...
- #17488 fix "coinwowd already running" warnings on macOS (fanquake)
