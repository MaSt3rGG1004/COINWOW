COINWOW-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/coinwow/files/COINWOW/coinwow-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the COINWOW
...
New/changed settings (command-line or coinwow.conf file)
--------------------------------------------------------
