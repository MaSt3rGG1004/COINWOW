COINWOW Core version 0.9.4 is now available from:

  https://coinwow.org/bin/0.9.4/
...
this update is incompatible with the COINWOW system and could lead to consensus
forks.

COINWOW Core released binaries from https://coinwow.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~coinwow/+archive/ubuntu/coinwow
- A third-party or self-compiled COINWOW Core

upgrade to COINWOW Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
