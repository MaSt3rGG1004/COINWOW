COINWOW Core version 0.9.2.1 is now available from:

  https://coinwow.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CW to 0.01 CW
...
- Fix "Start coinwow on system login"
