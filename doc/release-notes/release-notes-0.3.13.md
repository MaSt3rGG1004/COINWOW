...
Download:
http://sourceforge.net/projects/coinwow/files/COINWOW/coinwow-0.3.13/
...
http://www.coinwow.org/download/coinwow-0.3.13.1-specialbuild-linux64.tar.gz
...
http://www.coinwow.org/download/coinwow-0.3.13.2-win32-setup.exe
