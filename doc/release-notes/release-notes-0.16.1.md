COINWOW Core version 0.16.1 is now available from:

  <https://coinwowcore.org/bin/coinwow-core-0.16.1/>
...
- #12843 `df38b13` Test starting coinwowd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure coinwowd processes are cleaned up when tests end (sdaftuar)
