COINWOW version 0.5.4 is now available for download at:
http://sourceforge.net/projects/coinwow/files/COINWOW/coinwow-0.5.4/
...
http://gitorious.org/coinwow/coinwowd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix COINWOW-Qt notifications under Growl 1.3.
Increase required age of COINWOW-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCOINWOW properly when installing COINWOW-Qt over it. (Windows)
