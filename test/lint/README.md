...
```sh
DOCKER_BUILDKIT=1 docker build -t coinwow-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/coinwow -it coinwow-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/coinwow-core/crc32c-subtree.git (branch coinwow-fork)
* for `src/crypto/ctaes`: https://github.com/coinwow-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/coinwow-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/coinwow-core/leveldb-subtree.git (branch coinwow-fork)
* for `src/minisketch`: https://github.com/coinwow-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/coinwow-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/coinwow-core/secp256k1.git
```
