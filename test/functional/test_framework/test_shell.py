...
class TestShell:
    """Wrapper Class for COINWOWTestFramework.

    The TestShell class extends the COINWOWTestFramework
    ...
    class __TestShell(COINWOWTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by COINWOWTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # COINWOWTestFramework instances are supposed to be constructed with the path
