...
def create_coinbase(height, pubkey=None, *, script_pubkey=None, extra_output_script=None, fees=0, nValue=25, retarget_period=REGTEST_RETARGET_PERIOD):
