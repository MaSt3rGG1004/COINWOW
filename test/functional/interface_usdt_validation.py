...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/coinwow/coinwow/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/coinwow/coinwow/blob/master/doc/tracing.md#tracepoint-validationblock_connected
