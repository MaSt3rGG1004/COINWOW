...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The coinwowd node closes feeler connections as soon as a version
...
class P2PAddConnections(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        # coinwowd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that coinwowd sends its own version prior to processing
