...
class WalletTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        # Send 10 CW with subtract fee from amount
        ...
        # Sendmany 10 CW with subtract fee from amount
        ...
        # Sendmany 5 CW to two addresses with subtracting fee from both addresses
