...
class SignMessagesWithPrivTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        expected_signature = 'H/fgjNy0dMnkecdpl7zs3epDYaf0EAji+OpeOX2MeoQjJldKTzCFKuh/7dvcpwKPbXGJ2s+ZYXbPVBS2qN4D2zc='
