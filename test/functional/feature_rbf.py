...
class ReplaceByFeeTest(COINWOWTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.txid_hex}; new feerate 0.00300000 CW/kvB <= old feerate 0.00300000 CW/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 CW - so this attempt is rejected.
