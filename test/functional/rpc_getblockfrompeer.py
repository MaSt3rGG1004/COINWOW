...
class GetBlockFromPeerTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(pruned_node.getblock(pruned_block)["hash"], "2796465059a0b69738597d972f3e8df85824c952041109fbc0b615783051c3a4")
