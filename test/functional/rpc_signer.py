...
Verify that a coinwowd node can use an external signer command.
...
class RPCSignerTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart coinwowd with -signer=<cmd>',
