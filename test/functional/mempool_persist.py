...
By default, coinwowd will dump mempool on shutdown and
...
class MempoolPersistTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent coinwowd from writing mempool.dat to disk. Verify that `savemempool` fails")
