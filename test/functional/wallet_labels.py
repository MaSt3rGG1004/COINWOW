...
class WalletLabelsTest(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 COINWOWs
        ...
        for address_group in address_groups:
            ...
            assert_equal(address_group[0][1], 25)
