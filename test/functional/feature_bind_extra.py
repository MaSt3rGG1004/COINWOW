...
"""
Test starting coinwowd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(COINWOWTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that coinwowd has bound on "::1" (for RPC) and "::" (for P2P).
