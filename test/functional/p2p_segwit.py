...
class SegWitTest(COINWOWTestFramework):
    ...
    def test_non_witness_transaction(self):
        ...
        tx.vout.append(CTxOut(24 * 100000000, CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))
        ...
        self.utxo.append(UTXO(tx.txid_int, 0, 24 * 100000000))
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older coinwowd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let coinwowd fill it in.
