...
# Copyright 2016-present The COINWOW Core developers
...
class ToolUtils(COINWOWTestFramework):
    ...
    def skip_test_if_missing_module(self):
        self.skip_if_no_coinwow_tx()
        self.skip_if_no_coinwow_util()
    ...
    def test_one(self, testObj):
        ...
        if testObj["exec"] == "./coinwow-util":
            execrun = self.bins.util_argv() + testObj["args"]
        elif testObj["exec"] == "./coinwow-tx":
