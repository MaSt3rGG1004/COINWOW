...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the COINWOWTestFramework
    pass


class ExampleTest(COINWOWTestFramework):
    # Each functional test is a subclass of the COINWOWTestFramework class.
    ...
    def custom_method(self):
        ...
        COINWOWTestFramework class so other tests can use it."""
