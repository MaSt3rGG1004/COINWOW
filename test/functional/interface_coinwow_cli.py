#!/usr/bin/env python3
# Copyright (c) 2017-2022 The COINWOW Core developers
...
# The block reward of coinbaseoutput.nValue (25) CW/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 25 CW/block.
BLOCKS = COINBASE_MATURITY + 1
BALANCE = (BLOCKS - COINBASE_MATURITY) * 25
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"coinwow-cli -h\" for help or \"coinwow-cli listwallets\" to see "
...
class TestCOINWOWCli(COINWOWTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `coinwow-cli getblockchaininfo`")
        ...
        # Prevent coinwow-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and coinwow-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and coinwow-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (CW/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (CW/kvB)']), network_info['relayfee'])
            assert_equal(self.nodes[0].cli.getwalletinfo(), wallet_info)

            # Setup to test -getinfo, -generate, and -rpcwallet= with multiple wallets.
            wallets = [self.default_wallet_name, 'Encrypted', 'secret']
            amounts = [BALANCE + Decimal('4.999928'), Decimal('4.5'), Decimal('15.5')]
            ...
            # Mine a block to confirm; adds a block reward (25 CW) to the default wallet.
            ...
            # Test coinwow-cli -generate with -rpcwallet in multiwallet mode.
