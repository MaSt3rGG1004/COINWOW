...
#ifndef COINWOW_WALLET_WALLET_H
#define COINWOW_WALLET_WALLET_H
...
public:
     ...
     * coinwow-wallet tool code or by wallet migration code. If this is called
