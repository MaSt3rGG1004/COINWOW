// Copyright (c) 2019-2021 The COINWOW Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef COINWOW_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define COINWOW_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // COINWOW_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
