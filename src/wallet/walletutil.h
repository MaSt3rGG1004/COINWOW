// Copyright (c) 2017-2021 The COINWOW Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef COINWOW_WALLET_WALLETUTIL_H
#define COINWOW_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! coinwow from opening the wallet, thinking it was newly created, and
...
#endif // COINWOW_WALLET_WALLETUTIL_H
