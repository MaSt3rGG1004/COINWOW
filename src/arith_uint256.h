...
#ifndef COINWOW_ARITH_UINT256_H
#define COINWOW_ARITH_UINT256_H
...
public:
     ...
     *
     * COINWOW only uses this "compact" format for encoding difficulty
