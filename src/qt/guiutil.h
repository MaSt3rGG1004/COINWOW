...
#ifndef COINWOW_QT_GUIUTIL_H
#define COINWOW_QT_GUIUTIL_H
...
/** Utility functions used by the COINWOW Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "coinwow:" URI into recipient object, return true on successful parsing
