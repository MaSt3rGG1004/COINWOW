...
#ifndef COINWOW_QT_OPTIONSMODEL_H
#define COINWOW_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for COINWOW client.
...
public:
    ...
    COINWOWUnit getDisplayUnit() const { return m_display_coinwow_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSCWontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    COINWOWUnit m_display_coinwow_unit;
...
Q_SIGNALS:
    void displayUnitChanged(COINWOWUnit unit);
...
#endif // COINWOW_QT_OPTIONSMODEL_H
