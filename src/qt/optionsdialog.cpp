      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->coinwowAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->coinwowAtStartup);
    ...
    ui->coinwowAtStartup->setToolTip(ui->coinwowAtStartup->toolTip().arg(CLIENT_NAME));
    ui->coinwowAtStartup->setText(ui->coinwowAtStartup->text().arg(CLIENT_NAME));

    ui->openCOINWOWConfButton->setToolTip(ui->openCOINWOWConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new COINWOWUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->coinwowAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSCWontrols);
...
void OptionsDialog::on_openCOINWOWConfButton_clicked()
{
