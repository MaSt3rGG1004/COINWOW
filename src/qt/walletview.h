...
#ifndef COINWOW_QT_WALLETVIEW_H
#define COINWOW_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a coinwow wallet, and offers access to
