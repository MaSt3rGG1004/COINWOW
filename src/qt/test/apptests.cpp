...
//! Entry point for COINWOWApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &COINWOWApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for COINWOWGUI tests.
void AppTests::guiTests(COINWOWGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &COINWOWGUI::consoleShown, this, &AppTests::consoleTests);
