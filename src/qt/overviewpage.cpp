...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = COINWOWUnits::formatWithUnit(unit, amount, true, COINWOWUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    COINWOWUnit unit{COINWOWUnit::CW};
...
{
    COINWOWUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(COINWOWUnits::formatWithPrivacy(unit, balances.balance, COINWOWUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(COINWOWUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, COINWOWUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(COINWOWUnits::formatWithPrivacy(unit, balances.immature_balance, COINWOWUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(COINWOWUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, COINWOWUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CW")
    updateDisplayUnit();
}
