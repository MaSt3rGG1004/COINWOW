...
#ifndef COINWOW_QT_COINWOWGUI_H
#define COINWOW_QT_COINWOWGUI_H
...
/**
  COINWOW GUI main class. This class represents the main window of the COINWOW UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class COINWOWGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit COINWOWGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~COINWOWGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a coinwow wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, COINWOWUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed COINWOW Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(COINWOWUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // COINWOW_QT_COINWOWGUI_H
