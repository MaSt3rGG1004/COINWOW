...
#ifndef COINWOW_QT_RECEIVECOINSDIALOG_H
#define COINWOW_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of coinwows */
...
#endif // COINWOW_QT_RECEIVECOINSDIALOG_H
