...
#ifndef COINWOW_QT_SENDCOINSENTRY_H
#define COINWOW_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending coinwows.
 */
...
#endif // COINWOW_QT_SENDCOINSENTRY_H
