...
#ifndef COINWOW_QT_COINWOWUNITS_H
#define COINWOW_QT_COINWOWUNITS_H
...
/** COINWOW unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class COINWOWUnits: public QAbstractListModel
{
    Q_OBJECT
