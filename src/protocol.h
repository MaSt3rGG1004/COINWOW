...
#ifndef COINWOW_PROTOCOL_H
#define COINWOW_PROTOCOL_H
...
/**
 * COINWOW protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all COINWOW Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // coinwow-development mailing list. Remember that service bits are just
