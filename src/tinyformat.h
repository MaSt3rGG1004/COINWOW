...
#include <algorithm>
#include <attributes.h> // Added for COINWOW Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for COINWOW Core
#include <util/string.h> // Added for COINWOW Core
...
// Added for COINWOW Core. Similar to std::runtime_format from C++26.
...
// Added for COINWOW Core. Wrapper for checking format strings at compile time.
