...
#ifndef COINWOW_CLIENTVERSION_H
#define COINWOW_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by coinwow-build-config.h or in any other way
#endif
