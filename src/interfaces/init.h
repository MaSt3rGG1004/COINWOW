...
#ifndef COINWOW_INTERFACES_INIT_H
#define COINWOW_INTERFACES_INIT_H
...
//! (coinwow-gui, coinwow-node, coinwow-wallet, coinwowd, coinwow-qt) and each
...
#endif // COINWOW_INTERFACES_INIT_H
