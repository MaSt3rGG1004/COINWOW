...
#ifndef COINWOW_INTERFACES_NODE_H
#define COINWOW_INTERFACES_NODE_H
...
//! Top-level interface for a coinwow node (coinwowd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or coinwow.conf.
...
#endif // COINWOW_INTERFACES_NODE_H
