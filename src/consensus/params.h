...
#ifndef COINWOW_CONSENSUS_PARAMS_H
#define COINWOW_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a COINWOW Script solution
...
#endif // COINWOW_CONSENSUS_PARAMS_H
