...
#ifndef COINWOW_RPC_UTIL_H
#define COINWOW_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting CW/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1CW/kvB.
 */
