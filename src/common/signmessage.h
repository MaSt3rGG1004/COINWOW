...
#ifndef COINWOW_COMMON_SIGNMESSAGE_H
#define COINWOW_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's coinwow address, it must refer to a public key.
...
#endif // COINWOW_COMMON_SIGNMESSAGE_H
