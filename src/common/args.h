...
#ifndef COINWOW_COMMON_ARGS_H
#define COINWOW_COMMON_ARGS_H
...
extern const char * const COINWOW_CONF_FILENAME;
extern const char * const COINWOW_SETTINGS_FILENAME;
