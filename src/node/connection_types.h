...
#ifndef COINWOW_NODE_CONNECTION_TYPES_H
#define COINWOW_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/coinwow-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on COINWOW’s Peer-to-Peer Network")
...
#endif // COINWOW_NODE_CONNECTION_TYPES_H
