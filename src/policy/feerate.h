...
#ifndef COINWOW_POLICY_FEERATE_H
#define COINWOW_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "CW"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    CW_KVB,      //!< Use CW/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::CW_KVB) const;
...
#endif // COINWOW_POLICY_FEERATE_H
