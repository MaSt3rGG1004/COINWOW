...
#ifndef COINWOW_TXGRAPH_H
#define COINWOW_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingcoinwow.org/t/introduction-to-cluster-linearization/1032
 *
