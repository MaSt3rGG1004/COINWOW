...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of COINWOW Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("coinwow"), "Coinwow");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    const std::string expected_signature =
        "H6ZJ0U4jVWROsrIhlxonteIRfEHbhW0DvXL9mU60yCUXOBkX1PBlI0BH7Swntn0kHCASCog4fyK/Z4ap8JoPe08=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "ca8j8sySAYwro53EgZC4NwAcm39GS3ZHk3",
            "signature should be irrelevant",
            "message too"),
...
BOOST_AUTO_TEST_CASE(util_WriteBinaryFile)
{
    ...
    std::string expected_text = "coinwow";
