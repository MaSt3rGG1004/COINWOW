// Copyright (c) 2019-2020 The COINWOW Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef COINWOW_TEST_UTIL_TRANSACTION_UTILS_H
#define COINWOW_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // COINWOW_TEST_UTIL_TRANSACTION_UTILS_H
