...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common coinwow"}; // Includes a space to catch possible path escape issues.
    ...
    : TestingSetup{ChainType::REGTEST, opts}
{
...

    {
        ...
        assert(
            ...
            "410b4964a3a989f75f495978de62375941c7be69fd6fdacdd74e127efbc8a58c");
    }
}
