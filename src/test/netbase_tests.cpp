...
{
    BOOST_CHECK(TestSplitHost("www.coinwowcore.org", "www.coinwowcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.coinwowcore.org]", "www.coinwowcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.coinwowcore.org:80", "www.coinwowcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.coinwowcore.org]:80", "www.coinwowcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.coinwowcore.org:65536", "www.coinwowcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.coinwowcore.org:0", "www.coinwowcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.coinwowcore.org:", "www.coinwowcore.org:", 0, false));
}
