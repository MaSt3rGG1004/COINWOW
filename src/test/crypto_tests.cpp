...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As COINWOW relies on 80 byte header hashes, we want to have an example for that.",
               "0d910f684adf32e2f5c5a7598723118ef45b6b24f280e9a745ef307d899635b4");
