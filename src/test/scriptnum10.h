...
#ifndef COINWOW_TEST_SCRIPTNUM10_H
#define COINWOW_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from COINWOW Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // COINWOW_TEST_SCRIPTNUM10_H
