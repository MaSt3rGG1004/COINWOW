...
#ifndef COINWOW_TXREQUEST_H
#define COINWOW_TXREQUEST_H
 ...
 *   specific transaction. See https://coinwowcore.org/en/2024/07/03/disclose_already_asked_for.
 */
