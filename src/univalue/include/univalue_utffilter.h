...
#ifndef COINWOW_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define COINWOW_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // COINWOW_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
