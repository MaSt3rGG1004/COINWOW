...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("030e9a20c8ce6a3f1bcf5334686f97deea3ee515da760a774c9b77b5fed21ceef7") << OP_CHECKSIG;
...
//         assert(genesis.hashMerkleRoot == uint256{"55eea7049f3a5c35ef99330df21519822467e05b234c892e126d6180f53be896"});
        ...
        m_assumeutxo_data = {
            {   // For use by unit tests
                .height = 110,
                .hash_serialized = AssumeutxoHash{uint256{"c31a410b1d4e45667c78de80412b9f1e5e9ca433660ff12aa16398365765911c"}},
                .m_chain_tx_count = 111,
                .blockhash = consteval_ctor(uint256{"3b1491587c465ceddf97d9eb352e24d5662bb4aa0315cf0a44c47642455864dc"}),
            },
            {
            ...
            },
            {
                ...
                .height = 299,
                .hash_serialized = AssumeutxoHash{uint256{"2b6571bf7acb59b57336eab19ec601a5afcbfe0232827a27f36ca570c540c731"}},
                .m_chain_tx_count = 334,
                .blockhash = consteval_ctor(uint256{"2bdc6c61a87576e003069dcd4dc893f173b9eebed56fb25914a307e3f969486c"}),
            },
        };
