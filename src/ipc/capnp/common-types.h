...
#ifndef COINWOW_IPC_CAPNP_COMMON_TYPES_H
#define COINWOW_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between coinwow processes.
...
//! Functions to serialize / deserialize common coinwow types.
namespace mp {
...
#endif // COINWOW_IPC_CAPNP_COMMON_TYPES_H
