...
extern thread_local ThreadContext g_thread_context; // NOLINT(coinwow-nontrivial-threadlocal)
// Silence nonstandard coinwow tidy error "Variable with non-trivial destructor
