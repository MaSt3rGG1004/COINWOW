...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef COINWOW_CHAINPARAMSSEEDS_H\n')
    g.write('#define COINWOW_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the coinwow network\n')
    ...
    g.write('#endif // COINWOW_CHAINPARAMSSEEDS_H\n')
