...
# Extract options
function __fish_coinwow_tx_get_options
...
# Extract commands
function __fish_coinwow_tx_get_commands
...
complete \
    --command coinwow-tx \
    --condition "not __fish_coinwow_seen_cmd (__fish_coinwow_tx_get_commands --commandsonly)" \
    --arguments "(__fish_coinwow_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command coinwow-tx \
    --arguments "(__fish_coinwow_tx_get_commands)" \
    --no-files
