...
complete --command coinwowd --no-files

# Extract options
function __fish_coinwowd_get_options
...
complete \
    --command coinwowd \
    --arguments "(__fish_coinwowd_get_options --nofiles)"
