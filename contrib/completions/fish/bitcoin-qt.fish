...
complete --command coinwow-qt --no-files

# Extract options
function __fish_coinwowqt_get_options
...
complete \
    --command coinwow-qt \
    --arguments "(__fish_coinwowqt_get_options --nofiles)"
