...
declare -A LIBS
LIBS[cli]="libcoinwow_cli.a"
LIBS[common]="libcoinwow_common.a"
LIBS[consensus]="libcoinwow_consensus.a"
LIBS[crypto]="libcoinwow_crypto.a"
LIBS[node]="libcoinwow_node.a"
LIBS[util]="libcoinwow_util.a"
LIBS[wallet]="libcoinwow_wallet.a"
...
# https://github.com/coinwow/coinwow/issues/10102
