...
Arguments:
    <base_directory> - The base directory of a coinwow source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The COINWOW Core developers'
...
// Copyright (c) <firstYear>-<lastModifiedYear> The COINWOW Core developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The COINWOW Core developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The COINWOW Core developers
...
CPP_HEADER = '''
// Copyright (c) %s The COINWOW Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The COINWOW Core developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The COINWOW Core developers" at the top of the
...
If the file already has a copyright for "The COINWOW Core developers", the
script will exit.
...
Arguments:
    <file> - A source file in the coinwow repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The COINWOW
