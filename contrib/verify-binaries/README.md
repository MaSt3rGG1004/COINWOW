...
As of COINWOW Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/coinwow-core/guix.sigs/). When
...
builder-keys](https://github.com/coinwow-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://coinwowcore.org and https://coinwow.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/coinwow-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/coinwow-24.0.1-arm-linux-gnueabihf.tar.gz
```
