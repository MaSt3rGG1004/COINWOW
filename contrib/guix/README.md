...
This directory contains the files necessary to perform bootstrappable COINWOW
Core builds.
...
To build COINWOW Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      COINWOW Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/coinwow-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/coinwow-core/guix.sigs).
