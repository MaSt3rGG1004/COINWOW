...
def check_ELF_FORTIFY(binary) -> bool:
    ...
    # coinwow-util does not currently contain any fortified functions
    if 'COINWOW Core coinwow-util utility version ' in binary.strings:
        return True
    # coinwow wrapper does not currently contain any fortified functions
