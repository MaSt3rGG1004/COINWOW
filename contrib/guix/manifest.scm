...
(define* (make-coinwow-cross-toolchain target
                                       #:key
...
desirable for building COINWOW Core release binaries."
...
;; failure; see https://github.com/coinwow/coinwow/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-coinwow-cross-toolchain target)))
